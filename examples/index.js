const { ParcelLabApi } = require('../dist');

const user = 1;
const token = 'parcelLabAPItoken-30characters';

const payloadTrackingExample1 = {
    courier: 'dhl-germany',
